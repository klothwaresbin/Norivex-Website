...
function AssessmentForm() {
  ...
  async function handleAssessmentSubmit(event: FormSubmitEvent) {
    ...
    const payload: AssessmentPayload = {
      ...
      turnstileToken: getFormValue(data, 'cf-turnstile-response'),
    };
